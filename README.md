# AWS SAM Node 10 Template
AWS SAM [Cookiecutter](https://github.com/audreyr/cookiecutter) template for creating a Node 10.x project.
...
```
$ sam init --location gh:serverlessopsio/aws-sam-node10
```
